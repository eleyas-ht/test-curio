...
export default function QuantityStepper({
  ...
  const btn =
    'grid place-items-center text-ink transition-fluid hover:bg-ink/[0.06] disabled:opacity-30 disabled:pointer-events-none';
  ...
  return (
    <div
      className={cn(
        'inline-flex items-center border border-line rounded-md bg-paper',
        disabled && 'opacity-60',
      )}
      role="group"
